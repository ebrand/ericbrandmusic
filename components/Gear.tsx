import { liveGear } from "@/data/gear";

export default function Gear() {
  return (
    <section id="gear" className="mx-auto max-w-6xl px-6 py-24">
      <h2 className="mb-2 font-heading text-3xl font-bold text-white">Live Gear</h2>
      <p className="mb-12 text-zinc-400">What I bring to the stage.</p>
